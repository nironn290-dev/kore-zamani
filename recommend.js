...
Format:
{"oneriler":[{"kisabaslik":"Kısa Türkçe isim (max 2-3 kelime, örn: Penthouse, Goblin, Vincenzo)","orijinal":"Orijinal dildeki tam isim (değişmez, key olarak kullanılır)","ulke":"Kore veya Japon veya Cin","tur":"dizi veya film","yil":"2020","imdb":"8.4","altbaslik":"10-15 kelimelik çarpıcı ve spesifik açıklama cümlesi (örn: Lüks bir rezidansta gizlenen karanlık sırlar ve acımasız intikam)","ozet":"2 cümle detaylı özet."}]}
Tam 5 öneri ver. altbaslik her zaman aynı kalmalı, spesifik ve o diziye özgü olmalı.`;
